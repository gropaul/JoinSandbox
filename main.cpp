...
const vector<uint64_t> BUILD_CARDINALITIES = {100000, 300000, 1000000, 3000000, 1000000, 3000000, 10000000, 30000000};
const vector<uint64_t> PROBE_CARDINALITIES = {100000, 300000, 1000000, 3000000, 1000000, 3000000, 10000000, 30000000};
